      ...
      {!selectedConversation ? (
        ...
        <>
          ...
          <div className="bg-gray-200 px-4 py-2 mb-2 flex items-center justify-between shadow-sm">
            <span className="text-gray-700 text-sm font-semibold">
              ...
              {selectedConversation.firstName +
                " " +
                selectedConversation.lastName || "Unknown User"}
            </span>
            ...
            <span className="text-gray-500 text-xs">
              ...
              <Popup
                trigger={
                  <Button
                    variant="primary"
                    className="bg-[#F0F2E3] text-grey border-none"
                  >
                    {" "}
                    Open Todo List{" "}
                  </Button>
              ...
              >
                <div className="rounded-lg bg-white p-6 shadow-md">
                  <div className="mb-4 flex items-center">
                    <input
                      className="w-full bg-[#F0F2E3] rounded-md border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      type="text"
          ...
          <div className="bg-gray-200 mt-2 px-4 py-3">
            ...
            <MessageInput
              replyMsg={replyMsg}
              resetReplyMsg={() => setReplyMsg(null)}
            />
          </div>
        </>
      )}
